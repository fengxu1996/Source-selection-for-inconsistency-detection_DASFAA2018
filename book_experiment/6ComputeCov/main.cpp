...
string dir="C:\\Users\\12433\\Desktop\\Data_book\\";
...
//    /**测试*/
//    argv[1]="200"; argv[2]="5"; argv[3]="5"; argv[4]="100"; argv[5]="100"; argv[6]="book"; argv[7]="SelectedSrcs";
    ...
    fin.close();
    file=dir+"FD.txt";/**哈哈哈哈哈哈哈，原来BUG在这啊，终于让我找到了*/
    fin.open(file.c_str(),ios::in);
    while(fin>>s)
    {
        HanShuYiLaiAdd(s);
